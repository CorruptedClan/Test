...
local Window = OrionLib:MakeWindow({Name = "GenRebornAlphaTest544^H", HidePremium = false, SaveConfig = false, ConfigFolder = "AlphajajIiI9_$", IntroEnabled = true, IntroText = "MUP8700@"})
